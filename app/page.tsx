				...
				<div className='relative container mx-auto px-4 text-center'>
					<div className='max-w-4xl mx-auto'>
						...
						<p className='text-lg sm:text-xl text-gray-700 mb-10 leading-relaxed max-w-3xl mx-auto'>
							Experience nature's purest flavours with our handcrafted range of
							certified organic foods – sustainably grown, ethically sourced,
							and delivered fresh from our farms to your family.
						</p>
